...
const Sidebar: React.FC<SidebarProps> = ({ activePage, onNavigate }) => {
  ...
  return (
    <aside className="w-64 h-screen bg-dark-surface border-r border-dark-border flex flex-col fixed left-0 top-0 z-50">
      {/* Header */}
      <div className="p-6 flex items-center gap-3 border-b border-dark-border/50 shrink-0">
      ...
      <div className="p-4 border-t border-dark-border/50 shrink-0 bg-dark-surface">
